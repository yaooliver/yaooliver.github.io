...
$('.citizen').html(a);
for (m = 0; m < date; m++){
    $('.details').append("<div class='day'><div class='date'>第<span></span>天</div><p>白天：<span class='shift'></span>号玩家被杀死，其身份是<span class='shift'></span></p><p>晚上：<span class='shift'></span>号玩家被投死，其身份是<span class='shift'></span></p></div>");
